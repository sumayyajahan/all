...
include("databaseConnection.php");
 ...
 while($row=mysql_fetch_array($re)){
     ...
     ?><tr><td align="left" style="background-color:#5E767E;"><p><?php echo $row['event_name'];?></p></td><td align="left" style="background-color:#5E767E;"><p><?php echo $row['amount']."/=";?></p></td><tr>
