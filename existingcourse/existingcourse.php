...
<div align="center">
<div style="border:1px solid gold;width:1100px;height:250px;overflow-y:scroll;overflow-x:hidden;" >
<table bgcolor="#CFECEC" align="center">
<tr><th style="background-color:#383838 ;"><p>Department name</p></th><th style="background-color:#383838 ;"><p>Course code</p></th><th style="background-color:#383838 ;"><p>Course title</p></th><th style="background-color:#383838 ;"><p>Credit hour</p></th><th style="background-color:#383838 ;"><p>Click to</p></th></tr>
<?php 
include("databaseConnection.php");
$re=mysql_query("select *from course_info order by department_name asc,course_code asc"); 
while($row=mysql_fetch_array($re)){
    $id=$row['course_id'];
    $self=$_SERVER['PHP_SELF'];

?>
<tr><td align="left" style="background-color:#5E767E;"><p><?php echo $row['department_name']; ?></p></td><td align="left" style="background-color:#5E767E;"><p><?php echo $row['course_code'] ?></p></td><td align="left" style="background-color:#5E767E;"><p><?php echo $row['course_title']; ?></p></td><td align="center" style="background-color:#5E767E;"><p><?php echo $row['credit_hour']; ?></p></td><th align="center" style="background-color:#5E767E;"><?php echo "<a href = \"$self?id=$id\">Add to chart</a>"; ?></th></tr> 
<?php } ?>
</table>
</div><br/>
...
<div>
  <table bgcolor="#CFECEC" align="center">
<tr><th style="background-color:#383838 ;"><p>Department name</p></th><th style="background-color:#383838 ;"><p>Session</p></th><th style="background-color:#383838 ;"><p>Course code</p></th><th style="background-color:#383838 ;"><p>Credit hour</p></th><th style="background-color:#383838 ;"><p>Click to</p></th></tr>
<?php 
include("databaseConnection.php");
...
echo $dept['department_name'];?></p></td><td align="left" style="background-color:#5E767E;"><p><?php echo $row1['session'] ?></p></td><td align="left" style="background-color:#5E767E;"><p><?php echo $row1['course_code']; ?></p></td><td align="center" style="background-color:#5E767E;"><p><?php echo $row1['credit_hour']; ?></p></td><th align="center" style="background-color:#5E767E;"><?php echo "<a href = \"$selfish?di=$di\">Delete</a>"; ?></th></tr> 
<?php } ?>
</table>
...
{
    $del=$_GET['di'];
    mysql_query("delete from existingcourse where excourse_id='$del'");
